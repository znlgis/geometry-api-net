...
namespace Esri.Geometry.Tests.IO
{
    public class EsriJsonTests
    {
        ...
        public void TestPointEsriJsonRoundTrip()
        {
            ...
            string esriJson = EsriJsonExportOperator.Instance.Execute(point);
        ...
        public void TestMultiPointEsriJsonRoundTrip()
        {
            ...
            string esriJson = EsriJsonExportOperator.Instance.Execute(multiPoint);
            var parsed = EsriJsonImportOperator.ImportFromEsriJson(esriJson);
        ...
        public void TestPolylineEsriJsonRoundTrip()
        {
            ...
            string esriJson = EsriJsonExportOperator.Instance.Execute(polyline);
            var parsed = EsriJsonImportOperator.ImportFromEsriJson(esriJson);
        ...
        public void TestPolygonEsriJsonRoundTrip()
        {
            ...
            string esriJson = EsriJsonExportOperator.Instance.Execute(polygon);
            var parsed = EsriJsonImportOperator.ImportFromEsriJson(esriJson);
        ...
        public void TestEnvelopeEsriJsonRoundTrip()
        {
            ...
            string esriJson = EsriJsonExportOperator.Instance.Execute(envelope);
            var parsed = EsriJsonImportOperator.ImportFromEsriJson(esriJson);
