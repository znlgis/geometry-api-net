...
namespace Esri.Geometry.Tests.IO
{
    public class GeoJsonTests
    {
        ...
        {
            var polyline = new Polyline();
            var path1 = new System.Collections.Generic.List<Point>
            {
                new Point(0, 0),
                new Point(10, 0)
            };
            var path2 = new System.Collections.Generic.List<Point>
            {
                new Point(20, 20),
                new Point(30, 30)
            };
        ...
        public void TestPolygonGeoJsonExportImport()
        {
            ...
            var ring = new System.Collections.Generic.List<Point>
            {
                new Point(0, 0),
                new Point(10, 0),
                new Point(10, 10),
