...
namespace Esri.Geometry.Tests.Operators
{
    public class SimplifyOGCOperatorTests
    {
        ...
        {
            var point = new Point(10, 20);
            bool isSimple = SimplifyOGCOperator.Instance.IsSimpleOGC(point);
        ...
        public void TestIsSimpleOGCMultiPoint()
        {
            ...
            bool isSimple = SimplifyOGCOperator.Instance.IsSimpleOGC(multiPoint);
        ...
        public void TestIsSimpleOGCPolyline()
        {
            ...
            bool isSimple = SimplifyOGCOperator.Instance.IsSimpleOGC(polyline);
        ...
        public void TestIsSimpleOGCPolygon()
        {
            ...
            bool isSimple = SimplifyOGCOperator.Instance.IsSimpleOGC(polygon);
        ...
        public void TestIsSimpleOGCEnvelope()
        {
            ...
            bool isSimple = SimplifyOGCOperator.Instance.IsSimpleOGC(envelope);
        ...
        public void TestIsSimpleOGCUsingGeometryEngine()
        {
            ...
            bool isSimple = GeometryEngine.IsSimpleOGC(point);
        ...
        public void TestSimplifyOGCWithForceSimplify()
        {
            ...
            var simplified = SimplifyOGCOperator.Instance.Execute(polyline, null, forceSimplify: true);
