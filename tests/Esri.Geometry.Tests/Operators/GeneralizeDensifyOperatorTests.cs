...
namespace Esri.Geometry.Tests.Operators
{
    public class GeneralizeDensifyOperatorTests
    {
        ...
        public void GeneralizeOperator_PolylineWithManyPoints_RemovesVertices()
        {
            ...
            var result = GeneralizeOperator.Instance.Execute(polyline, maxDeviation: 0.5);
        ...
        public void GeneralizeOperator_Polygon_PreservesShape()
        {
            ...
            var result = GeneralizeOperator.Instance.Execute(polygon, maxDeviation: 0.5);
        ...
        public void GeneralizeOperator_MultiPoint_RemovesClosePoints()
        {
            ...
            var result = GeneralizeOperator.Instance.Execute(multiPoint, maxDeviation: 0.5);
        ...
        public void GeneralizeOperator_Point_RemainsUnchanged()
        {
            ...
            var result = GeneralizeOperator.Instance.Execute(point, maxDeviation: 1.0);
        ...
        public void DensifyOperator_Line_AddsIntermediatePoints()
        {
            ...
            var result = DensifyOperator.Instance.Execute(line, maxSegmentLength: 2.0);
        ...
        public void DensifyOperator_Polyline_AddsVertices()
        {
            ...
            var result = DensifyOperator.Instance.Execute(polyline, maxSegmentLength: 3.0);
        ...
        public void DensifyOperator_Polygon_MaintainsClosedRing()
        {
            ...
            var result = DensifyOperator.Instance.Execute(polygon, maxSegmentLength: 3.0);
        ...
        public void DensifyOperator_Point_RemainsUnchanged()
        {
            ...
            var result = DensifyOperator.Instance.Execute(point, maxSegmentLength: 1.0);
        ...
        public void DensifyOperator_WithZCoordinates_PreservesZ()
        {
            ...
            var result = DensifyOperator.Instance.Execute(line, maxSegmentLength: 3.0);
        ...
        public void GeneralizeAndDensify_RoundTrip_ProducesReasonableResult()
        {
            ...
            // Densify it
            var densified = DensifyOperator.Instance.Execute(polyline, maxSegmentLength: 2.0);
            var densifiedPolyline = (Polyline)densified;
            Assert.True(densifiedPolyline.GetPath(0).Count > 3);

            // Then generalize it back
            var generalized = GeneralizeOperator.Instance.Execute(densified, maxDeviation: 0.1);
