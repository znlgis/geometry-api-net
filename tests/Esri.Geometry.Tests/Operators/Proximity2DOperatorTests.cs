...
namespace Esri.Geometry.Tests.Operators
{
    public class Proximity2DOperatorTests
    {
        ...
        public void TestGetNearestCoordinateFromEnvelopeInterior()
        {
            ...
            var result = Proximity2DOperator.Instance.GetNearestCoordinate(envelope, inputPoint, testPolygonInterior: true);
        ...
        public void TestGetNearestVertices()
        {
            ...
            var results = Proximity2DOperator.Instance.GetNearestVertices(multiPoint, inputPoint, searchRadius: 10.0);
        ...
        public void TestGetNearestVerticesMaxCount()
        {
            ...
            var results = Proximity2DOperator.Instance.GetNearestVertices(multiPoint, inputPoint, searchRadius: 100.0, maxVertexCount: 2);
        ...
        public void TestGetNearestCoordinateFromPolygonExterior()
        {
            ...
            var result = Proximity2DOperator.Instance.GetNearestCoordinate(polygon, inputPoint, testPolygonInterior: false);
        ...
        public void TestGetNearestCoordinateFromPolygonInterior()
        {
            ...
            var result = Proximity2DOperator.Instance.GetNearestCoordinate(polygon, inputPoint, testPolygonInterior: true);
        ...
        public void TestGetNearestVerticesUsingGeometryEngine()
        {
            ...
            var results = GeometryEngine.GetNearestVertices(multiPoint, inputPoint, searchRadius: 10.0);
