...
namespace Esri.Geometry.Core.Operators
{
    ...
    {
        private static readonly Lazy<IntersectsOperator> _instance = new Lazy<IntersectsOperator>(() => new IntersectsOperator());
        ...
        public bool Execute(Geometries.Geometry geometry1, Geometries.Geometry geometry2, SpatialReference.SpatialReference? spatialRef = null)
        {
            ...
            throw new NotImplementedException($"Intersects test between {geometry1.Type} and {geometry2.Type} is not yet implemented.");
        }
    }
}
