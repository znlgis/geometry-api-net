...
namespace Esri.Geometry.Core.Operators
{
    ...
    {
        private static readonly Lazy<OverlapsOperator> _instance = new Lazy<OverlapsOperator>(() => new OverlapsOperator());
        ...
        public bool Execute(Geometries.Geometry geometry1, Geometries.Geometry geometry2, SpatialReference.SpatialReference? spatialRef = null)
        {
            ...
            if (geometry1 is Envelope env1 && geometry2 is Envelope env2)
            {
                ...
                bool env1ContainsEnv2 = env2.XMin >= env1.XMin && env2.XMax <= env1.XMax &&
                                       env2.YMin >= env1.YMin && env2.YMax <= env1.YMax;
                bool env2ContainsEnv1 = env1.XMin >= env2.XMin && env1.XMax <= env2.XMax &&
            ...
            throw new NotImplementedException($"Overlaps test between {geometry1.Type} and {geometry2.Type} is not yet implemented.");
        }
    }
}
