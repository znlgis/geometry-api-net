...
namespace Esri.Geometry.Core.Operators
{
    ...
    public class CentroidOperator : IGeometryOperator<Point>
    {
        ...
        private static readonly Lazy<CentroidOperator> _instance = new Lazy<CentroidOperator>(() => new CentroidOperator());
        ...
        public Point Execute(Geometries.Geometry geometry, SpatialReference.SpatialReference? spatialRef = null)
        {
            ...
            {
                return CalculateMultiPointCentroid(multiPoint);
            }
            ...
            {
                return CalculatePolylineCentroid(polyline);
            }
