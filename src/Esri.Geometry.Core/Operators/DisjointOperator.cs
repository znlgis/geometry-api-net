...
namespace Esri.Geometry.Core.Operators
{
    ...
    {
        private static readonly Lazy<DisjointOperator> _instance = new Lazy<DisjointOperator>(() => new DisjointOperator());
        ...
        public bool Execute(Geometries.Geometry geometry1, Geometries.Geometry geometry2, SpatialReference.SpatialReference? spatialRef = null)
        {
            ...
            if (geometry1 is Envelope env3 && geometry2 is Point p2)
            {
                return !env3.Contains(p2);
            }
            ...
            {
                throw new NotImplementedException($"Disjoint test between {geometry1.Type} and {geometry2.Type} is not yet implemented.");
            }
        }
    }
}
