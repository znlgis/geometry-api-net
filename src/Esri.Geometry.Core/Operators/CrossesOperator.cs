...
namespace Esri.Geometry.Core.Operators
{
    ...
    {
        private static readonly Lazy<CrossesOperator> _instance = new Lazy<CrossesOperator>(() => new CrossesOperator());
        ...
        public bool Execute(Geometries.Geometry geometry1, Geometries.Geometry geometry2, SpatialReference.SpatialReference? spatialRef = null)
        {
            ...
            throw new NotImplementedException($"Crosses test between {geometry1.Type} and {geometry2.Type} is not yet implemented.");
        }
    }
}
