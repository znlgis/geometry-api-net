...
namespace Esri.Geometry.Core.Operators
{
    ...
    {
        private static readonly Lazy<WithinOperator> _instance = new Lazy<WithinOperator>(() => new WithinOperator());
        ...
        public bool Execute(Geometries.Geometry geometry1, Geometries.Geometry geometry2, SpatialReference.SpatialReference? spatialRef = null)
        {
            ...
            {
                throw new NotImplementedException($"Within test between {geometry1.Type} and {geometry2.Type} is not yet implemented.");
            }
        }
    }
}
