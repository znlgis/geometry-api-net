...
namespace Esri.Geometry.Core.Operators
{
    ...
    {
        private static readonly Lazy<DensifyOperator> _instance = 
            new Lazy<DensifyOperator>(() => new DensifyOperator());
        ...
        public Geometries.Geometry Execute(Geometries.Geometry geometry, double maxSegmentLength, SpatialReference.SpatialReference? spatialReference = null)
        {
            if (geometry == null)
        ...
        private Geometries.Geometry DensifyPolygon(Polygon polygon, double maxSegmentLength)
        {
            ...
            {
                var densifiedRing = DensifyPath(ring, maxSegmentLength, closeRing: true);
        ...
        private List<Point> DensifySegment(Point start, Point end, double maxSegmentLength)
        {
            ...
            int numSegments = (int)Math.Ceiling(segmentLength / maxSegmentLength);
        ...
        Geometries.Geometry IGeometryOperator<Geometries.Geometry>.Execute(Geometries.Geometry geometry, SpatialReference.SpatialReference? spatialReference)
        {
